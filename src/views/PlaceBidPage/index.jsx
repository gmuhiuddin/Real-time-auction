...
function PlaceBidPage() {
    ...
    const handlePlaceBid = async (e) => {
        ...
        if (authInfo?.uid && product?.uid != authInfo.uid && bids && authInfo?.uid != bids[0]?.uid && bids[0].bidAmount < e.target[0].value) {
            try {
            ...
            <>
                ...
                <div className="place-bid-container">
                    <form onSubmit={handlePlaceBid}>
                        ...
                        <button disabled={authInfo?.uid ? product?.uid == authInfo.uid ? true : bids && authInfo?.uid == bids[0]?.uid : true} type='submit'>Bid</button>
                    </form>
                    <div>
                        {bids ?
                            <table>
